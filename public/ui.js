...
function fillUserListResponse(response) {
...
function displayPostsResponse(response) {
    let postsDiv = document.getElementById("posts");
...
function newPost() {
    ...
    let authorSelect = document.getElementById("new-post-author");
    let userID = authorSelect.options[authorSelect.selectedIndex].value;
    let contentTextArea = document.getElementById("new-post-content");
